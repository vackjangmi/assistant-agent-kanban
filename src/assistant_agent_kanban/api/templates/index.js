    ...
    const settingsTranslations = {
      EN: {
        ...
        basicsDescription: 'Language, theme, repository defaults, and local Slack settings.',
        ...
        slackBasicsTitle: 'Basics',
        slackBasicsDescription: 'Turn Slack on, add a bot token, choose the default channel, then run one test to activate it.',
        ...
        slackSaveNoteTitle: 'Activation flow',
        slackSaveNote: 'Save stores Slack settings only. Use the Slack test to verify the bot and activate the channel shown above.',
        slackBotTokenLabel: 'Bot token',
        slackAppTokenLabel: 'App token',
        slackChannelLabel: 'Default channel',
        slackChannelDescription: 'Enter a human-friendly Slack channel. A new default only becomes active after a successful Slack test resolves and saves it.',
        slackEffectiveChannelLabel: 'Active channel',
        slackEffectiveChannelHelp: 'This is the saved channel currently used for default Slack messages.',
        slackChannelNote: 'Use a channel name like <code>#agent-alerts</code>. The active channel stays unchanged until <strong>Test Slack</strong> succeeds.',
        slackChannelUnset: 'Not configured.',
        slackChannelPendingNone: 'No pending channel change. The saved Slack channel remains active.',
        slackChannelPendingFirst: 'No default Slack channel is active yet. Enter a channel and run <strong>Test Slack</strong> to resolve and activate it.',
        slackChannelPendingChange: 'Pending channel input: <code>{channel}</code>. The effective channel will not change until <strong>Test Slack</strong> succeeds and saves the resolved Slack channel.',
        slackChannelPendingClear: 'The input is now blank, but the effective channel stays <code>{channel}</code> until a successful Slack test saves a replacement.',
        slackClearToken: 'Clear saved token',
        slackTestDescription: 'Send a real test message from the current form values. A successful test resolves and saves the effective default channel.',
        ...
        tokenLabel: 'Token',
        agentsLabel: 'Agent',
        plannerNote: 'Assistant override, model, token budget, and parallel agents.',
        requestDraftNote: 'Assistant override and model for composer-only drafting help.',
        planApprovalNote: 'Assistant override, model, and token budget for auto-approve decisions.',
        implementerNote: 'Assistant override, model, token budget, and parallel agents.',
        reviewerNote: 'Assistant override, model, token budget, and parallel agents.',
        commitNote: 'Assistant override, model, and token budget.',
        cancel: 'Close',
        saveSettings: 'Save',
      ...
      KO: {
        ...
        basicsHeading: '기본값',
        basicsDescription: '언어, 테마, 저장소 기본 설정과 로컬 Slack 설정입니다.',
        ...
        slackBasicsTitle: '기본 설정',
        slackBasicsDescription: 'Slack을 켜고, Bot 토큰과 기본 채널을 입력한 뒤, 한 번의 테스트로 채널을 활성화하세요.',
        slackEnabledLabel: '활성화',
        slackSocketModeLabel: 'Socket Mode',
        slackMentionLabel: '앱 멘션',
        slackNote: 'Slack 값은 로컬 설정 파일에만 저장되며 task metadata에는 기록되지 않습니다.',
        slackSaveNoteTitle: '활성화 흐름',
        slackSaveNote: '저장은 Slack 설정값만 반영합니다. 위 채널을 실제로 검증하고 활성화하려면 Slack 테스트를 실행하세요.',
        slackBotTokenLabel: 'Bot 토큰',
        slackAppTokenLabel: 'App 토큰',
        slackChannelLabel: '기본 채널',
        slackChannelDescription: '사람이 읽기 쉬운 Slack 채널 값을 입력하세요. 새 기본 채널은 Slack 테스트가 성공하여 resolve 및 저장된 뒤에만 활성화됩니다.',
        slackEffectiveChannelLabel: '활성 채널',
        slackEffectiveChannelHelp: '기본 Slack 메시지에 현재 사용 중인 저장된 채널입니다.',
        slackChannelNote: '<code>#agent-alerts</code> 같은 채널명을 사용하세요. 활성 채널은 <strong>Slack 테스트</strong>가 성공하기 전까지 바뀌지 않습니다.',
        slackChannelUnset: '설정되지 않았습니다.',
        slackChannelPendingNone: '대기 중인 채널 변경이 없습니다. 저장된 Slack 채널이 계속 적용됩니다.',
        slackChannelPendingFirst: '아직 적용 중인 기본 Slack 채널이 없습니다. 채널을 입력하고 <strong>Slack 테스트</strong>를 실행하면 resolve 후 활성화됩니다.',
        slackChannelPendingChange: '대기 중인 채널 입력값: <code>{channel}</code>. <strong>Slack 테스트</strong>가 성공하여 resolve된 Slack 채널을 저장하기 전까지는 적용 채널이 바뀌지 않습니다.',
        slackChannelPendingClear: '입력값은 비어 있지만 적용 채널은 <code>{channel}</code> 상태로 유지됩니다. 성공한 Slack 테스트가 대체 채널을 저장해야 변경됩니다.',
        slackClearToken: '저장된 토큰 삭제',
        slackTestDescription: '현재 폼 값으로 실제 테스트 메시지를 보냅니다. 테스트가 성공하면 적용 기본 채널이 resolve 및 저장됩니다.',
        ...
        tokenLabel: 'Token',
        agentsLabel: '에이전트',
        plannerNote: '어시스턴트 오버라이드, 모델, 토큰 예산, 병렬 수.',
        requestDraftNote: '작성 보조용 어시스턴트 오버라이드와 모델입니다.',
        planApprovalNote: '어시스턴트 오버라이드, 모델, 토큰 예산.',
        implementerNote: '어시스턴트 오버라이드, 모델, 토큰 예산, 병렬 수.',
        reviewerNote: '어시스턴트 오버라이드, 모델, 토큰 예산, 병렬 수.',
        commitNote: '어시스턴트 오버라이드, 모델, 토큰 예산.',
        cancel: '닫기',
        saveSettings: '저장',
